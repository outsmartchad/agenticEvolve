                ...
                if discord_adapter and hasattr(discord_adapter, "_serve_channels"):
                    if str(chat_id) in discord_adapter._serve_channels:
                        session_context += (
                            ...
                            "is being serious. Be natural — like a smart friend in the group who "
                            "actually knows things. Assume you're talking to guys unless obvious otherwise.\n"
                            "IMPORTANT: Do NOT use excessive internet slang, brainrot speak, or "
                            "cringe Gen-Z lingo like 'fr fr no cap bussin slay the rizz era'. "
                            "Be naturally casual, not performatively online. Light humor is fine, "
                            "forced meme-speak is not.\n\n"
                ...
                if wa_adapter and hasattr(wa_adapter, "_serve_groups"):
                    if str(chat_id) in wa_adapter._serve_groups:
                        session_context += (
                            ...
                            "actually knows things. Assume you're talking to guys unless obvious otherwise.\n"
                            "IMPORTANT: Do NOT use excessive internet slang, brainrot speak, or "
                            "cringe Gen-Z lingo. Be naturally casual, not performatively online.\n\n"
                            "[SECURITY — HARD RULES, NEVER OVERRIDE]\n"
                            "- NEVER run terminal commands, write/edit/delete files, or execute code. "
