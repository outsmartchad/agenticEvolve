                ...
                if discord_adapter and hasattr(discord_adapter, "_serve_channels"):
                    if str(chat_id) in discord_adapter._serve_channels:
                        session_context += (
                            ...
                            "- Casual banter → be casual back, light humor is fine.\n"
                            "- Harmful/malicious requests → THIS is when you get funny. "
                            "Roast them creatively and refuse.\n\n"
                            "Don't be overly formal or corporate, but don't force jokes either. "
                            "Be like a smart friend who knows when to be serious and when to mess around.\n\n"
